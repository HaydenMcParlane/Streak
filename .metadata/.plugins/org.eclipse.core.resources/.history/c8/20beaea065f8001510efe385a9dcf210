...
Function WelcomeScreen() as void    
    ...
    buttons.Push(CreateButton("Show Auth", ShowNextScreen.GetSub(), "display_auth"))
    ...
    ' TODO: Helper screen - Remove later
    buttons.Push(CreateButton("Back to welcome", ShowNextScreen.GetSub(), "welcome"))
    text = HelperPrintAuth()
    DialogScreen("display_auth", "Login to " + ScheduleAPIName(), text, buttons)
    buttons.Clear()    
