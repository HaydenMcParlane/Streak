...
Function WelcomeScreen() as void
    ...
    pButtons.Push( ConstructButton(1, "Button 1", CommandNextScreen("other")) )
    oButtons.Push( ConstructButton(1, "Button 2", CommandNextScreen("welcome")) )    
