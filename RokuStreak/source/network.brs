...
Function StoreRequest(id as Integer, listeningPort as Object) as void    
    dataStore = AppNetworkDataStore()
    dataStore.AddReplace(Str(id), listeningPort) ' Store async roUrlTransfer with its ID as hash value
End Function

Function GetAsyncRequestPort(id as Integer) as Object
    requests = AppNetworkDataStore() 
    return requests[Str(id)]
End Function

Function AppNetworkDataStore() as Object
