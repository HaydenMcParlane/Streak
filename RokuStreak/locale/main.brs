'DataType Name(params as type) as returnType
...
Function InitTheme() as void
    ...
    theme = {
        ...
        OverhangSliceSD:            "pkg:/locale/default/images/Overhang_BackgroundSlice_SD.png"
        OverhangLogoSD:             "pkg:/locale/default/images/json.png"
        OverhangOffsetHD_X:         "18"
        OverhangOffsetHD_Y:         "0"
        OverhangSliceHD:            "pkg:/locale/default/images/Overhang_BackgroundSlice_HD.png"
        OverhangLogoHD:             "pkg:/locale/default/images/json.png"
    }
    app.SetTheme(theme)
...
Function LoadJSONFile() as void
    jsonAsString = ReadAsciiFile("pkg:/locale/json/sample1.json")    
...
Function LoadXMLFile() as void
    ...
    xmlParser.Parse(ReadAsciiFile("pkg:/locale/xml/removelater/sample1.xml"))    
